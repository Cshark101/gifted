...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~m74WiYiS#SDEe60TPpYpCc-yyWYm-pHjhhTo7E2K7sluzvlqSmhA", // Add sess Id here especially when deploying on panels else use app.json and .env file...
